...
export default function Citizen() {
    ...
    const { id, nft } = usePassport({ address, enabled: isConnected })
    const { data: passportSignerData } = usePassportSigner({ id })
    ...
    const [passportSigner, setPassportSigner] = useState(passportSignerData || address || constants.AddressZero)
