...
const config: Config = {
  ...
  etherscanDomain:
    chain === 'goerli' ? 'https://goerli.etherscan.io' : 'https://etherscan.io',
  lpRewardsContract: defaultConfig.lpRewardsContract || zeroAddress,
  mobilePassportDomain:
    chain === 'goerli'
      ? 'https://mobile-passport-goerli.vercel.app'
      : 'https://passports.nation3.org',
  ...
  nationPassportAgreementStatement:
    defaultConfig.nationPassportAgreementStatement || '',
  nationPassportAgreementURI: defaultConfig.nationPassportAgreementURI || '',
  nationPassportRequiredBalance: Number(
    defaultConfig.nationPassportRequiredBalance
  ),
}
